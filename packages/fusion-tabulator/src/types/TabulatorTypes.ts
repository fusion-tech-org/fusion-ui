...
declare namespace Tabulator {
  ...
  interface OptionsGeneral {
    ...
    dataSorted?:
      | ((sorters: Sorter[], rows: RowComponent[]) => void)
      | undefined;
...
interface EventCallBackMethods {
  ...
  columnMoved: (
    ...
    columns: Tabulator.ColumnComponent[]
  ) => void;
...
declare class Tabulator {
  ...
  static bindModules: (values: unknown[]) => void;
  ...
  clearCellEdited: (
    clear?: Tabulator.CellComponent | Tabulator.CellComponent[]
  ) => void;
...
*
  ...
  */
  ...
  selectRow: (
    lookup?: Tabulator.RowLookup[] | Tabulator.RowRangeLookup | true
  ) => void;
  ...
  */
  ...
  clearCellValidation: (
    clearType?: Tabulator.CellComponent | Tabulator.CellComponent[]
  ) => void;
  /**You can validate the whole table in one go by calling the validate method on the table instance.
   *
