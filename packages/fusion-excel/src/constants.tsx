export const EXCEL_FETCHING_TIPS = '文件正在请求中...';

export const EXCEL_DATA_PARSING_TIPS = '文件数据在解析中...';

export const workerScripts = `
  importScripts('http://localhost:3009/read-excel-file-webworker.min.js', 'http://localhost:3009/read-excel-sheet-names.min.js');
